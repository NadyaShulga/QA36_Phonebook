...
public class ListenerWD implements WebDriverListener {
    ...
    public void onError(Object target, Method method, Object[] args, InvocationTargetException e) {
        ...
        logger.info("Tests have a 'problem'");
        logger.info("-------------------------------------------------");
        logger.info("Method method" +method.getName());
        logger.info("-------------------------------------------------");
        logger.info("InvocationTargetException getTargetException"+ e.getTargetException());
        logger.info("-------------------------------------------------");
      //  logger.info("InvocationTargetException getMessage"+ e.getMessage());
        //  logger.info("-------------------------------------------------");
       // logger.info("InvocationTargetException getCause"+ e.getCause());
       // logger.info("-------------------------------------------------");
